...
<body>
       ...
       <table class="table table-striped">
            <thead>
                <tr class="bg-primary">
                <th scope="row">Id</td>
                <th scope="row">Nome do proprietário</td>
                <th scope="row">Endereço do imóvel</td>
                <th scope="row">Número do imóvel</td>
                <th scope="row">Bairro do imóvel</td>
                    ...
                    while( $dados = mysqli_fetch_assoc($consulta) )
                        {
                            echo 
                                "<tr>
                                <td>" .$dados['id_imovel']. "</td>
                                <td>" .$dados['nm_locador']. "</td>
                                <td>" .$dados['end_imovel']. "</td>
                                <td>" .$dados['num_imovel']. "</td>
                                <td>" .$dados['bairro_imovel']. "</td>
                                <td>" .$dados['cid_imovel']. "</td>
                                </tr>";
            }
        ?>
        </table>
