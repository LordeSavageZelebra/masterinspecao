...
<h1 class="text-center">Você realmente deseja remover este imóvel ?</h1><br><br>
<form action="removeimovel.php" method="post">

	<input type="hidden" name="id" value="<?php echo $data['id_imovel'] ?>" />
	<center>
